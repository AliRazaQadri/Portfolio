...
var numberCondition = +prompt("Enter a number to check whether the number is positive, negative or zero. :");

if (numberCondition > 0) {
    alert(numberCondition + " is a Positive number");
} else if (numberCondition < 0) {
    alert(numberCondition + " is a Negative number");
} else {
...
var character = prompt("Enter a single character to check it is a vowel or not:");
...
if (time >= 0 && time < 1200) {
    ...
    alert("Invalid input! Please enter a valid 24-hour time (0000 - 2359).");
}
